...
//   .then(Rdata=>{
//       console.log(Rdata.Countries[0].Country)
//       var i;
//       for (i=0; i<Rdata.Countries.length; i++){
//         arr1.push(Rdata.Countries[i].Country)
//         arr2.push(Rdata.Countries[i].TotalConfirmed)
//       }
...
d3.queue()
  ...
  //           arr1.push(d.Countries[i].Country)
  //           arr2.push(d.Countries[i].TotalConfirmed)
  //         }
  //         console.log(arr1)
  //         data.set(arr1, arr2);
  //         console.log(data)
